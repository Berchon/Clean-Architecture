...
type OrderServiceClient interface {
	...
	ListOrders(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*OrdersListResponse, error)
}
...
func (c *orderServiceClient) ListOrders(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*OrdersListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type OrderServiceServer interface {
	...
	ListOrders(context.Context, *Blank) (*OrdersListResponse, error)
...
func (UnimplementedOrderServiceServer) ListOrders(context.Context, *Blank) (*OrdersListResponse, error) {
