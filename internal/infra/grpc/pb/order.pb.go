...
const file_internal_infra_grpc_protofiles_order_proto_rawDesc = "" +
	...
	"\x03tax\x18\x03 \x01(\x02R\x03tax\"h\n" +
	...
	"\fOrderService\x12:\n" +
	"\vCreateOrder\x12\x16.pb.CreateOrderRequest\x1a\x11.pb.OrderResponse\"\x00\x121\n" +
	"\n" +
	"ListOrders\x12\t.pb.Blank\x1a\x16.pb.OrdersListResponse\"\x00B\x18Z\x16internal/infra/grpc/pbb\x06proto3"
...
var file_internal_infra_grpc_protofiles_order_proto_goTypes = []any{
	...
	(*OrdersListResponse)(nil), // 3: pb.OrdersListResponse
}
var file_internal_infra_grpc_protofiles_order_proto_depIdxs = []int32{
	2, // 0: pb.OrdersListResponse.orders:type_name -> pb.OrderResponse
	...
	3, // 4: pb.OrderService.ListOrders:output_type -> pb.OrdersListResponse
